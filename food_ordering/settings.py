...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-food-ordering-secret-key-change-in-production')
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'food_app.context_processors.cart_count_processor',
            ],
        },
    },
]
